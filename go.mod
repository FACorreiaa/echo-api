...
require (
	buf.build/gen/go/echo-tracker/echo/protocolbuffers/go v1.36.11-20260116122612-2098e36ef271.1
...
require (
	buf.build/gen/go/echo-tracker/echo/connectrpc/go v1.19.1-20260116122612-2098e36ef271.2
