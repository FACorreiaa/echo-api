...
require (
	buf.build/gen/go/echo-tracker/echo/protocolbuffers/go v1.36.11-20260116174623-bf46540f2513.1
...
require (
	buf.build/gen/go/echo-tracker/echo/connectrpc/go v1.19.1-20260116174623-bf46540f2513.2
