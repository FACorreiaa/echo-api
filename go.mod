...
require (
	buf.build/gen/go/echo-tracker/echo/protocolbuffers/go v1.36.11-20260117151454-e56585fed1f0.1
...
require (
	buf.build/gen/go/echo-tracker/echo/connectrpc/go v1.19.1-20260117151454-e56585fed1f0.2
